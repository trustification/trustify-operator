...
# ghcr.io/trustify-operator-bundle:$VERSION and ghcr.io/trustify-operator-catalog:$VERSION.
...
install-trustify:
	$(shell pwd)/hack/install-trustify.sh

.PHONY: install-trustify-bundle
install-trustify-bundle:
	$(shell pwd)/hack/install-trustify-bundle.sh
